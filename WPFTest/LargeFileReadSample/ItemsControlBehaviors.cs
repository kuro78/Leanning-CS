...
public class ItemsControlBehavior : Behavior<ItemsControl>
{
    ...
    public static readonly DependencyProperty EnumerableDatasProperty =
        DependencyProperty.Register(nameof(EnumerableDatas), typeof(IEnumerable<object>),
            typeof(ItemsControlBehavior), new PropertyMetadata(null, EnumrableDatasChanged));

    private static void EnumrableDatasChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
    ...
    public static readonly DependencyProperty AsyncEnumerableDatasProperty =
        DependencyProperty.Register(nameof(AsyncEnumerableDatas), typeof(IEnumerable<object>), typeof(ItemsControlBehavior),
            new PropertyMetadata(null, AsyncEnumrableDatasChanged));

    private static void AsyncEnumrableDatasChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        var behavior = (ItemsControlBehavior)d;
